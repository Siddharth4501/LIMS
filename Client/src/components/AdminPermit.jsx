...
import AdminCommonPanel from './AdminCommonPanel';
                ...
                <div className='w-full flex'>
                    ...
                    <form className='flex flex-col gap-5 justify-center m-auto w-1/2 h-80 bg-gray-200 border-2 border-blue-600' onSubmit={handleSubmit}>
                        <div className='flex flex-col w-4/5 gap-3 justify-center mx-auto' >
                            ...
                            <div className='w-full'><input type="password" placeholder='Enter Verification Password...' name='verificationPassword' className='w-full border-2 border-blue-600 h-8 rounded pl-2 outline-0'/></div>
                        </div>
