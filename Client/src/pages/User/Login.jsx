...
const Login = () => {
  ...
  return (
    <div className="flex flex-col font-bold h-screen w-screen justify-center">
        <center><h1 className='text-4xl bg-gray-300 p-5'>Login Page</h1></center>
        <form onSubmit={handleLogin} className='grid gap-2 border border-gray-700 rounded-lg h-80 w-1/3 m-auto p-4 bg-slate-400'>
