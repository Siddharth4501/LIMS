...
//         const filteredRoles = allRoles.filter((role) => !selectedRoles.includes(role));
//         setRemainingRole(filteredRoles);
//     }
//     useEffect(()=>{
...
//                     )
//                     else
//                     console.log(item.designation,"wertpx")
//                     return(
                  
//                       <tr className="hover:bg-gray-100" key={`newSection-${index}`} >
//                         <td className="border border-gray-300 px-4 py-2 text-center">{index+1}.</td>
//                         <td className="border border-gray-300 px-4 py-2 text-center">
//                           <select name={`name-${item.designation}-${index}`} id={`id-${item.designation}-${index}`} className='bg-slate-100 py-1 w-3/4 border-2 border-blue-700' onChange={(e)=>handleRoleChange(e,index)}>
