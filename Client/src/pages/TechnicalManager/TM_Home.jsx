    ...
    return (
        <>
            ...
            <div className='grid grid-cols-2 gap-12 mt-16 px-4 py-2 m-auto w-3/4'>
                <center>
                    <button className='bg-red-500  shadow-lg shadow-red-500/50 w-80 px-4 py-2 rounded-md ml-8 text-2xl font-normal border-black border-2' onClick={handleSampleAllotment}>
                ...
                <center>
                    <button className='bg-cyan-500  shadow-lg shadow-cyan-500/50 w-80 px-4 py-2 rounded-md mr-32 text-2xl font-normal border-black border-2' onClick={handleResultApproval}>
                        <div className='flex flex-col gap-3'>
                ...
                <center>
                    <button className='bg-indigo-500  shadow-lg shadow-indigo-500/50 w-80 px-4 py-2 rounded-md ml-8 text-2xl font-normal border-black border-2' onClick={handlePendingSample}>
                        <div className='flex flex-col gap-3'>
                ...
                <center>
                    <button className='bg-blue-500 shadow-lg shadow-blue-500/50 w-80 px-4 py-2 rounded-md mr-32 text-2xl font-normal border-black border-2' onClick={handleApprovedResult}>
                        <div className='flex flex-col gap-3'>
